...
publishing {
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                name.set("Parsek i18n Plugin")
                description.set("i18n system for Parsek")
                url.set("https://github.com/ParsekDev/parsek-plugin-i18n")
                ...
                scm {
                    connection.set("scm:git:git://github.com/ParsekDev/parsek-plugin-i18n.git")
                    developerConnection.set("scm:git:ssh://github.com/ParsekDev/parsek-plugin-i18n.git")
                    url.set("https://github.com/ParsekDev/parsek-plugin-i18n")
                }
            }
        }
...
jreleaser {
    project {
        name.set("parsek-plugin-i18n")
        description.set("i18n system for Parsek")
        authors.add("Statu")
        license.set("MIT")
        links {
            homepage.set("https://github.com/ParsekDev/parsek-plugin-i18n")
        }
        inceptionYear.set("2025")
    }
